...
var SettingsPage = Vue.component('settings-page', {
  ...
  watch: {
    ...
    exceptions: {
      deep: true,
      handler: function handler(exceptionsAsArray, previousValue) {
  ...
  methods: {
    ...
    showExceptionsUploadModal: function showExceptionsUploadModal() {
      ...
      this.showUploadModal('tt-exceptions', function (result) {
        ...
        _(exceptions).defaults(_this3.exceptionsAsObject);

        Exceptions.updateGeneralExceptions(exceptions, _this3.reloadExceptions);
      });
    },
    ...
    resetStorage: function resetStorage() {
      ...
      if (confirm('Are you sure?')) {
        ...
        Settings.reset(function (value) {
          _this4.settings = value;
          var button = $(_this4.$refs.wipeOutButton);
