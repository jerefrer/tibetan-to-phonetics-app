var findException = function(tibetan) {
  ...
  switch(tibetan) {
    ...
    case 'ཡ་མཚན': transliteration = 'yam_tsèn'; break;
    ...
    case 'རྗེ་འབངས': transliteration = "jèm_bang"; break;
    case 'དགེ་འདུན': transliteration = "gèn_dün"; break;
    case 'འཕྲོ་འདུ': transliteration = "tr'on_du"; break;
    case 'རྒྱ་མཚོའི': transliteration = 'gyam_tsö'; break;
    case 'མཆོད་རྟེན': transliteration = 'chor_tèn'; break;
    ...
    case 'སྤྱན་རས་གཟིགས': transliteration = 'chèn_ré_zik'; break;
