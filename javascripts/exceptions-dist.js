...
var Exceptions = function Exceptions(setting, tibetan) {
  return {
    ...
    find: function find(tibetan) {
      ...
      if (exception) {
        if (modifier) {
          if (modifier == 'ས' && exception.last() == 'a') exception = exception.slice(0, -1) + t('drengbu');else if (modifier == 'ས' && exception.last() == 'o') exception = exception.slice(0, -1) + t('ö');else if (modifier == 'ས' && exception.last() == 'u') exception = exception.slice(0, -1) + t('ü');else exception += modifier;
        }
