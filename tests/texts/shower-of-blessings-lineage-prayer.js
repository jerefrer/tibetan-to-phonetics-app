testGroups.push({
  name: 'Shower of Blessings - Lineage Prayer' ,
  includeInPercentage: true,
  sentences: true,
  tests: [
    { tibetan: 'ཨེ་མ་ཧོ༔', transliteration: 'émaho' },
    { tibetan: 'ཀ་དག་མི་ཤིག་ཆོས་སྐུ་འོད་མཐའ་ཡས།', transliteration: 'katak mishik chöku önthayé' },
    ...
    { tibetan: 'བྱིན་གྱིས་རློབས་ཤིག་མ་ཧཱ་གུ་རུ་རྗེ།', transliteration: 'chinkyi lopshik maha guru jé' },
    { tibetan: 'མཆོག་ཐུན་དངོས་གྲུབ་གེགས་མེད་འགྲུབ་མཛད་གསོལ།', transliteration: 'chokthün ngötrup kekmé drupdzé söl' },
    { tibetan: 'གང་འདུལ་སྤྲུལ་སྐུ་པདྨ་སམྦྷ་ཝར།', transliteration: 'kangdül trülku padma sambhawar' },
    { tibetan: 'གསོལ་བ་འདེབས་སོ་ཕྱི་ནང་བར་ཆད་སོལ།', transliteration: 'sölwa depso chinang parché söl' },
    { tibetan: 'བྱིན་གྱིས་རློབས་ཤིག་མ་ཧཱ་གུ་རུ་རྗེ།', transliteration: 'chinkyi lopshik maha guru jé' },
    { tibetan: 'མཆོག་ཐུན་དངོས་གྲུབ་གེགས་མེད་འགྲུབ་མཛད་གསོལ།', transliteration: 'chokthün ngötrup kekmé drupdzé söl' },
    { tibetan: 'ཐུགས་སྲས་རྗེ་འབངས་དྲིན་ཅན་བླ་མ་རྗེ།', transliteration: 'thuksé jembang trinchen lama jé' },
    { tibetan: 'གསོལ་བ་འདེབས་སོ་ཕྱི་ནང་བར་ཆད་སོལ།', transliteration: 'sölwa depso chinang parché söl' },
    { tibetan: 'བྱིན་གྱིས་རློབས་ཤིག་མ་ཧཱ་གུ་རུ་རྗེ།', transliteration: 'chinkyi lopshik maha guru jé' },
    { tibetan: 'མཆོག་ཐུན་དངོས་གྲུབ་གེགས་མེད་འགྲུབ་མཛད་གསོལ།', transliteration: 'chokthün ngötrup kekmé drupdzé söl' },
